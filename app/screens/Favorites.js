...
export default function Favorites(props){
    ...
    return(
        <View style={styles.viewBody}>
            ...
            <Loading position="center" text="Eliminando Favorito" isVisible={isLoading}/>
        </View>
    );
...
function NotFoundRestaurants(){
    return(
        <View style={{flex: 1, alignItems:"center", justifyContent:"center"}}>
            ...
            color="red"
            />
            <Text style={{fontSize:15,fontWeight:"bold"}}>NO TIENES RESTAURANTES EN TU LISTA</Text>
        </View>
    )
}
    ...
    return(
        <View style={{flex: 1, alignItems:"center", justifyContent:"center"}}>
            ...
            <Button 
                ...
                buttonStyle={{backgroundColor:"#9acd36"}}
